...
#display(Image(filename='images/val/class/00acf132da8c63b2e3db83c69cbf6031.jpg'))
...
#size: 64, 128, 256
train_loader = torch.utils.data.DataLoader(train_imagefolder, batch_size=256, shuffle=True)

# Validation 
val_transforms = transforms.Compose([transforms.Resize(256), transforms.CenterCrop(224)])
val_imagefolder = GrayscaleImageFolder('images/val' , val_transforms)
val_loader = torch.utils.data.DataLoader(val_imagefolder, batch_size=256, shuffle=False)
...
pretrained = torch.load('models.pth', map_location=lambda storage, loc: storage)
